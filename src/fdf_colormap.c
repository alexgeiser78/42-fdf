...
/*   Updated: 2023/07/30 12:31:38 by ageiser          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	fdf_colormap(t_mlx *data, int *colors)
{
	...
	*/
	...
	//	{
	//		if (!(data->mapctr.map[x][y].color)) 
	//verifier pourquoi il n'y aurait pas de color dans color
	//			data->mapctr.map[x][y].color =
	//					colors[fdf_colorgradient_indice(data, x, y)]; 
	//fonction entre crochets donc induque la position dans le tab de couleur
