...
/*   Updated: 2023/07/27 19:10:00 by ageiser          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	i = 0;
//	if (str[i] == ',' && str[i + 1] == '0' && str[i + 2] == 'x') // 
//on peu imaginer que les coordonnes soient separees par des virgules
//		i += 3;
//	else
//		return (0);
//	color = 0;
...
int	fdf_atoi_color(const char *str, t_mapctr *mapctr, int x, int y)
{
	...
	*/
	...
	// quelque chose ne marche pas a ce niveau val a 0 tout le temps
